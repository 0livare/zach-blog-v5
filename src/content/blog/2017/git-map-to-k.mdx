---
title: A Shortcut For Git (on Windows)
...
Well that was easy! Open a bash shell and try it out! You'll have to close and re-open any bash windows that you currently have open. It's worth noting that this alias will not work in the windows command prompt.

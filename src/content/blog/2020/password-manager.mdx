...
heroImage: /images/blog/security/security.jpg
...
LastPass has a free tier so you can [get started](https://lastpass.com/create-account.php) without spending anything, but the free tier is somewhat limited. It has [browser extensions for all the major browsers](https://lastpass.com/misc_download2.php), as well as mobile applications for both iOS and Android.

> The free tier limits you to either always use LastPass on your mobile device, or always use LastPass on your computer. In my opinion, it's well worth the $3 per month to get access to both. [Here](https://www.lastpass.com/pricing-bundle) is the pricing model.
...
<img
  ...
  height={832}
  alt="lastpass menu"
  src="/static/images/blog/security/lastpass-generate-pass.png"
...
<img
  ...
  src="/static/images/blog/security/lastpass-gen-options.png"
  className="object-contain object-center max-h-[600px]"
/>

6.  Then copy the generated password (you can click the multiple squares icon to the right of the password, or select the generated password using your mouse, right click, and choose copy).
...
7.  Use the change password feature of the website to change your password.
    ...
    - Use LastPass' autofill feature to fill your current password by clicking the little box that appears in the text field. You could also just type it in if you already know it.
      ...
      <img
        width={670}
        height={168}
        src="/static/images/blog/security/lastpass-password-insert.png"
        alt="password fill insert"
        className="object-contain object-center max-h-24"
      />

    - Paste (right click, choose "Paste") the random password you generated into the new password field

8.  LastPass should prompt you to update your stored password, choose **Update**.

<img
  width={712}
  height={426}
  alt="LastPass password generator"
  src="/static/images/blog/security/lastpass-update-pass-prompt.png"
...
<sup>1</sup> Any password can be brute forced if given enough time. But by making your password sufficiently
complex, you can ensure that it will take a hacker with an extremely fast computer years to guess your
password. If the website declines access after `n` number of incorrect entries, then this strategy can
take centuries. This ability to eventually guess any password is why some places requires you to change
your password every so often.

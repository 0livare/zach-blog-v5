---
title: How to use Gremlin Cosmos DB with Azure Functions
description: The story that Microsoft docs, for some reason, refuse to tell you
author: Zach Olivare
date: 2020-07-19
tags: azure, nodejs, gremlin, cosmosDB
heroImage: /images/blog/azure-funcs/gremlin.png
slug: azure-functions-gremlin
---

import {Aside} from '~/components'

> Because of current limitations of Cosmos DB's Gremlin API, we'll see in this post that using the base gremlin NPM package is somewhat awkward and difficult. I've created a new library called [gremlin-cosmos](https://github.com/0livare/gremlin-cosmos) to make the interface between Gremlin and Cosmos more developer friendly.

<Aside variant="gray">
  This post assumes that you've already got an Azure Functions project set up and running locally on
  your computer. If not, please see to my{' '}
  <a href="/blog/azure-functions-getting-started">previous post</a> about how to do exactly that.
</Aside>
...
As I hinted at earlier, I've created a wrapper around the gremlin NPM package to make it easier to work with Cosmos' Gremlin API; it's called [gremlin-cosmos](https://github.com/0livare/gremlin-cosmos).

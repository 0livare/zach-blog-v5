...
5. Use the <Asterisk client:load tooltip='As if you were giving a command, without suffixes like "ed" or "ing"'>[imperative mood](https://en.wikipedia.org/wiki/Imperative_mood)</Asterisk> in the subject line

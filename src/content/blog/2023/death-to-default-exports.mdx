...
But if you `export default Thing1`, then in the barrel file the star export `export * from './thing1'` isn't going to work because Thing1 doesn't have a module name! So instead you're <Asterisk text={
...
}>forced</Asterisk> to give it one, similarly to how you would if you were trying to import the module:
